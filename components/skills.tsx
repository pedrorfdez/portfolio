...
export default function Skills() {
  const skillCategories = [
    ...
    },
    {
      ...
      icon: Database,
      skills: ["Apache Spark", "ETL Pipelines", "Data Warehousing", "PostgreSQL", "MongoDB", "Redis"],
    },
    {
      title: "Cloud & DevOps",
      icon: Cloud,
      skills: ["AWS", "Docker", "Kubernetes", "Git", "CI/CD", "Linux", "Terraform"],
    },
    {
      title: "Data Science & ML",
      icon: BarChart,
      skills: ["Machine Learning", "Pandas", "NumPy", "Scikit-learn", "TensorFlow", "Jupyter"],
    },
  ]
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            A comprehensive toolkit for modern software development and data engineering
          </p>
        </div>
